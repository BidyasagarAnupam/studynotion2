...
const VideoDetails = () => {
    ...
    const isFirstVideo = () => {
        ...
        console.log("CHECK for first video", courseSectionData);
        console.log("currentSectionIndex", currentSectionIndex);
        console.log("courseSectionData[currentSectionIndex]", courseSectionData[currentSectionIndex].subSection.findIndex((data) => data._id === subSectionId));
